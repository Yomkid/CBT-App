...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css/cbe.css') ?>">
    ...
    <link rel="stylesheet" href="<?= base_url('vendor/quill/quill.snow.css') ?>">
    <link rel="stylesheet" href="<?= base_url('vendor/quill/quill.bubble.css') ?>">
    <link rel="stylesheet" href="<?= base_url('vendor/remixicon/remixicon.css') ?>">
